...
namespace BackServer.Contexts
{
    public class TestContext : DbContext
    {
        ...
        public DbSet<SaleProducts> ProductsSale { get; set; }
        ...
        private void ProductPropertiesCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(x => new{x.PropertyId, x.ProductId});
        ...
        {
            modelBuilder.Entity<SaleProducts>(e => e.ToTable("products_sale"));
            
            modelBuilder.Entity<SaleProducts>(entity =>
            {
                entity.HasKey(x => new{x.SaleId, x.ProductId});
