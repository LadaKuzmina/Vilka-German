...
values  ('Парапетные крышки', 8, null, null),
    ...
    {
        var map = new Dictionary<string, ImportProductClass[]>()
        {
            {
                "Комплектующие", new[]
                {
                    new ImportProductClass("ehlementi-krovli/flyugery-duck--dog", "Флюгеры DUCK & DOG", null),
                    new ImportProductClass("ehlementi-krovli/kozyrki-krovent-iz-polikarbonata", "Козырьки", null)
                }
            },
            {
                "Кровля", new[]
                {
                    new ImportProductClass("profnastil", "Профнастил", "Профнастил"),
                    new ImportProductClass("metallocherepitsa", "Металлочерепица", "Металлочерепица"),
                    new ImportProductClass("krovlya/gibkaya-cherepitsa", "Гибкая черепица", null),
                    new ImportProductClass("krovlya/naturalnaya-cherepitsa", "Натуральная черепица", null),
                    new ImportProductClass("krovlya/keramicheskaya-cherepitsa", "Керамическая черепица",
                        "Модель черепицы"),
                    new ImportProductClass("krovlya/kompozitnaya-cherepitsa", "Композитная черепица", "Бренд"),
                    new ImportProductClass("krovlya/ondulin", "Ондулин", "Бренд"),
                    new ImportProductClass("krovlya/elementy-bezopasnosti-krovli", "Элементы безопасности кровли",
                        null),
                    new ImportProductClass("krovlya/dobornye-elementy", "Доборные элементы кровли", null),
                    new ImportProductClass("ehlementi-krovli/sofity", "Софиты", null)
                }
            },
            {
                "Фасад", new[]
                {
                    new ImportProductClass("fasadnye-paneli", "Фасадные панели", "Бренд"),
                    new ImportProductClass("fasad/fasadnaya-plitka", "Фасадная плитка", "Бренд"),
                    new ImportProductClass("fasad/komplektuyuschie", "Доборные элементы", null),
                    new ImportProductClass("fasad/podsistema-dlya-ventiliruemogo-fasada", "Подсистема для фасада",
                        "Элемент несущего каркаса"),
                    new ImportProductClass("fasad/sayding/vinilovyy", "Сайдинг виниловый", "Бренд"),
                    new ImportProductClass("fasad/sayding/metallosayding", "Сайдинг металлический", "Бренд"),
                    new ImportProductClass("fasad/sayding/fibrotsementnyy", "Сайдинг фиброцементный", "Бренд")
                }
            },
            {
                "Вентиляция", new[]
                {
                    new ImportProductClass("ventilacia/krovli", "Вентиляция кровли", "Вентиляция кровли"),
                    new ImportProductClass("ventilacia/ventilyatsionnye-vykhody", "Вентиляционные выходы",
                        "Вентиляционный выход"),
                    new ImportProductClass("ventilacia/ventilyatory", "Вентиляторы", "Вентиляторы"),
                    new ImportProductClass("ventilacia/prokhodnye-elementy", "Проходные элементы",
                        "Проходные элементы"),
                    new ImportProductClass("ventilacia/tsokolnye-deflektory", "Цокольные дефлекторы",
                        "Цокольные дефлекторы"),
                    new ImportProductClass("ventilacia/pritochnaya-ventilyatsiya", "Приточная вентиляция",
                        "Приточная вентиляция"),
                    new ImportProductClass("ventilacia/uplotniteli", "Уплотнители", "Уплотнители"),
                }
            },
            {
                "Водосток", new[]
                {
                    new ImportProductClass("vodostochnye-sistemy", "Бренд", "Бренд")
                }
            },
            {
                "Мансардные окна", new[]
                {
                    new ImportProductClass("mansardnye-okna/aksessuary-dlya-montazha", "Оклады для мансардных окно",
                        "Бренд"),
                    new ImportProductClass("mansardnye-okna/okna-lyuki", "Окна-люки", "Бренд"),
                    new ImportProductClass("mansardnye-okna/avariynye-vykhody", "Аварийные выходы", "Стеклопакет"),
                    new ImportProductClass("mansardnye-okna/karniznoe", "Карнизы", null)
                }
            },
            {
                "Чердачные лестницы", new[]
                {
                    new ImportProductClass("cherdachnye-lestnitsy", "Чердачные лестницы", "Материал")
                }
            },
            {
                "Изоляционные материалы", new[]
                {
                    new ImportProductClass("uteplenie-i-izolyatsiya/uteplitel", "Утеплители", "Назначение"),
                    new ImportProductClass("uteplenie-i-izolyatsiya/gidroizolyatsiya", "Гидро-пароизоляция",
                        "Тип изоляции"),
                    new ImportProductClass("uteplenie-i-izolyatsiya/profilirivannie-membrani",
                        "Профилированная мембрана", "Бренд"),
                    new ImportProductClass("uteplenie-i-izolyatsiya/master-flash", "Кровельные манжеты", null),
                    new ImportProductClass("uteplenie-i-izolyatsiya/germetiki", "Герметик", "Бренд"),
                    new ImportProductClass("uteplenie-i-izolyatsiya/bitumnye-materialy", "Битумные материалы", null),
                    new ImportProductClass("uteplenie-i-izolyatsiya/germetiziruyuschie-lenty", "Герметизирующие ленты",
                        "Бренд")
                }
            },
            {
                "Ограждения", new[]
                {
                    new ImportProductClass("zabor/modulnye-ograzhdeniya", "Модульные ограждения", null),
                    new ImportProductClass("zabor/panelnye-ograzhdeniya", "Панельные 3D ограждения", null),
                    new ImportProductClass("zabor/shtaketnik-metallicheskiy", "Штакетники", "Вид штакетника"),
                    new ImportProductClass("zabor/zabor-zhalyuzi", "Заборы Жалюзи", null),
                    new ImportProductClass("zabor/vremennye-ograzhdeniya", "Временные ограждения", null),
                    new ImportProductClass("zabor/planki-p-obraznye-zabornye", "Планки П-образные", null),
                    new ImportProductClass("zabor/parapetnye-kryshki", "Парапетные крышки", null),
                    new ImportProductClass("zabor/komplektuyuschie-dlya-zabora", "Комплектующиу для забора", null)
                }
            },
            {
                "Благоустройство", new[]
                {
                    new ImportProductClass("blagoustroystvo/terrasnaya-doska", "Террасная доска", "Бренд"),
                    new ImportProductClass("blagoustroystvo/drenazhnye-sistemy", "Дренажные системы", "Бренд")
                }
            }
        };
        foreach (var (headingOneTitle, value) in map)
        {
            ...
            {
                var objectResult = await InsertCategory(data.reff, headingOneTitle, data.headingTwoTitle,
        ...
        string? headingThreeProperty)
    {
        ...
        while (true)
        {
            var newRefs = await _dbAutoInsert.GetProductsRefs($"{categoryName}/page{pageNum}");
            if (newRefs.Count == 0)
                break;
        ...
        {
            var htmlDocument = await _dbAutoInsert.GetHtml(new Uri(productRef));
            if (htmlDocument == null)
            {
                _logger.Log(LogLevel.Warning,
                    $"Не удалось получить продукт по ссылке {productRef}");
                continue;
            }
            ...
            var imageRefs = htmlParse.GetProductImageRefs();
            foreach (var imageRef in imageRefs)
            {
                ...
                await _dbAutoInsert.DownloadImage(imageUri, imageName);
    ...
    private class ImportProductClass
    {
        ...
        public ImportProductClass(string reff, string headingTwoTitle, string? headingThreeProperty)
        {
            this.reff = reff;
