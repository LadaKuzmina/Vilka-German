...
let profiledCheckboxes = ["Braas", "Docke", "Gerard", "Grand Line", "Icopal", "Katepal", "Luxard", "Metrotile",
    "RoofShield", "Shinglas", "Tegola", "МеталлПрофиль"];

let widthCheckboxes = ["0,35 и менее", "0,4", "0,45", "0,5", "0,55", "0,6", "0,65", "0,7", "0,75", "0,8", "0,9", "1"];

let coatingCheckboxes = ["Полиэстер", "Полиэстер в пленке", "Цинк (Zn)", "AGNETA®", "CLOUDY®", "ECOSTEEL®", "PURETAN®",
    "PURMAN®","VALORI", "VikingMP", "VikingMP® E"];

let components = ["Элемент подконьковый", "Фартук", "Планка фронтонная", "Планка примыкания", "Планка карнизная",
    "Планка торцевая", "Планка защиты", "Планка прижимная", "Декоративная планка", "Наконечник конька",  "Крышка конька",
    "Конек", "Ендова", "Y-образный элемент", "Т-образный элемент",  "Тройник Y-конька",  "Заглушки"];
...
list.push(new Filter("warranty", components));
